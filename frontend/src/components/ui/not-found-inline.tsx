...
export default function NotFoundInline({ onClearFilters }: NotFoundInlineProps) {
  return (
    <div className="flex h-full flex-col w-full items-center justify-center bg-white dark:bg-gray-950 py-20">
      {/* Background Logo */}
